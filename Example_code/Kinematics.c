...
// Position of Right hand in Initial Pose (all the right arm motor angle == 0)
float x_0 = 0.0;
float y_0 = -174.0;
float z_0 = -12.0;
...
printf("ARM_R: %d   %d   %d\n", DXL_POS_1, DXL_POS_3, DXL_POS_5);

addparam_write(groupwrite_num, 1, DXL_POS_1 , 2);
addparam_write(groupwrite_num, 3, DXL_POS_3 , 2);
addparam_write(groupwrite_num, 5, DXL_POS_5 , 2);
...
printf("ARM_L: %d   %d   %d \n", DXL_POS_2, DXL_POS_4, DXL_POS_6);

addparam_write(groupwrite_num, 2, DXL_POS_2 , 2);
addparam_write(groupwrite_num, 4, DXL_POS_4 , 2);
addparam_write(groupwrite_num, 6, DXL_POS_6 , 2);
...
printf("LEG_R: %d   %d   %d   %d   %d\n", DXL_POS_7, DXL_POS_9, DXL_POS_11, DXL_POS_13, DXL_POS_15);

addparam_write(groupwrite_num, 7, DXL_POS_7 , 2);
addparam_write(groupwrite_num, 9, DXL_POS_9 , 2);
addparam_write(groupwrite_num, 11, DXL_POS_11 , 2);
addparam_write(groupwrite_num, 13, DXL_POS_13 , 2);
addparam_write(groupwrite_num, 15, DXL_POS_15 , 2);
...
printf("LEG_L: %d   %d   %d   %d   %d\n", DXL_POS_8, DXL_POS_10, DXL_POS_12, DXL_POS_14, DXL_POS_16);

addparam_write(groupwrite_num, 8, DXL_POS_8 , 2);
addparam_write(groupwrite_num, 10, DXL_POS_10 , 2);
addparam_write(groupwrite_num, 12, DXL_POS_12 , 2);
addparam_write(groupwrite_num, 14, DXL_POS_14 , 2);
addparam_write(groupwrite_num, 16, DXL_POS_16 , 2);
